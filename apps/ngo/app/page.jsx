    ...
    <div className="font-serif">
      ...
      <section className="relative bg-gradient-to-br from-white via-[#fdfdfd] to-[#f5f5f5] py-20 px-6 md:px-20">
        <div className="grid md:grid-cols-2 items-center gap-12 max-w-7xl mx-auto">
          <div>
            <p className="text-primary text-sm uppercase tracking-wide mb-2">Support Through Kindness</p>
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6 bg-gradient-to-r from-indigo-500 to-teal-400 text-transparent bg-clip-text">
              Receive Hope<br /> Request Essentials
            </h1>
            <p className="text-gray-700 mb-8 text-lg">
              NGOs and Individuals in need can now easily connect with donors and access vital supplies through our seamless platform.
            </p>
            <button
